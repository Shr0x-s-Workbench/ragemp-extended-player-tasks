...
//-----------------------------------------------------------//
mp.events.add("client::task:taskHeliMission", (vehicle: number, p2: any, pedToFollow: number, posX: number, posY: number, posZ: number, mode: number, speed: number, radius: number, angle: number, p11: number, height: number, p13: number, p14: number) => {
...
//-----------------------------------------------------------//
mp.events.add("client::task:taskPlaneMission", (plane: number, vehicleid: number, playerid: number, destinationX: number, destinationY: number, destinationZ: number, p7: number, physicsSpeed: number, p9: number, p10: number, maxAltitude: number, minAltitude: number) => {
...
//-----------------------------------------------------------//
mp.events.add("client::task:taskVehicleDriveToCoord", (vehicle: number, x: number, y: number, z: number, speed: number, p6: any, vehicleModel: Hash, drivingMode: number, stopRange: number, p10: number) => {
