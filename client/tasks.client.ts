...
mp.events.add("client::task:taskFollowNavMeshToCoordAdvanced", (x: number, y: number, z: number, speed: number, timeout: number, unkFloat: number, unkInt: number, unkX: number, unkY: number, unkZ: number, unk2: number) => {
...
mp.events.add("client::task:taskFollowToOffsetOf", (vehicleid: number, offsetX: number, offsetY: number, offsetZ: number, movementSpeed: number, timeout: number, stoppingRange: number, persistFollowing: boolean) => {
    const target = mp.vehicles.atRemoteId(vehicleid);
    if (!target || !mp.vehicles.exists(target)) return;
...
mp.events.add("client::task:taskGoToCoordAndAimAtHatedEntitiesNearCoord", (gotoX: number, gotoY: number, gotoZ: number, aimNearX: number, aimNearY: number, aimNearZ: number, speed: number, shoot: boolean, unknown1: number, unknown2: number, unkTrue: boolean, unknown3: number, heading: boolean, firingPattern: Hash) => {
...
mp.events.add("client::task:taskGoToCoordAnyMeansExtraParams", (x: number, y: number, z: number, speed: number, p5: any, p6: boolean, walkingStyle: number, p8: number, p9: any, p10: any, p11: any) => {
    mp.players.local.taskGoToCoordAnyMeansExtraParams(x, y, z, speed, p5, p6, walkingStyle, p8, p9, p10, p11);
});
mp.events.add("client::task:taskGoToCoordAnyMeansExtraParamsWithCruiseSpeed", (x: number, y: number, z: number, speed: number, p5: any, p6: boolean, walkingStyle: number, p8: number, p9: any, p10: any, p11: any, p12: any) => {
    mp.players.local.taskGoToCoordAnyMeansExtraParamsWithCruiseSpeed(x, y, z, speed, p5, p6, walkingStyle, p8, p9, p10, p11, p12);
});
mp.events.add("client::task:taskGoToCoordWhileAimingAtCoord", (x: number, y: number, z: number, aimAtX: number, aimAtY: number, aimAtZ: number, moveSpeed: number, p8: boolean, p9: number, p10: number, p11: boolean, flags: any, p13: boolean, firingPattern: Hash) => {
...
mp.events.add("client::task:taskHeliMission", (vehicle: Handle, p2: any, pedToFollow: Handle, posX: number, posY: number, posZ: number, mode: number, speed: number, radius: number, angle: number, p11: number, height: number, p13: number, p14: number) => {
    mp.players.local.taskHeliMission(vehicle, p2, pedToFollow, posX, posY, posZ, mode, speed, radius, angle, p11, height, p13, p14);
});
...
mp.events.add("client::task:taskLeaveVehicle", (targetvehicle: Handle, flags: number) => {
...
mp.events.add("client::task:taskMoveNetworkAdvanced", (p1: string, p2: number, p3: number, p4: number, p5: number, p6: number, p7: number, p8: any, p9: number, p10: boolean, animDict: string, flags: number) => {
    mp.players.local.taskMoveNetworkAdvanced(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, animDict, flags);
});
mp.events.add("client::task:taskOpenVehicleDoor", (targetvehicle: Handle, timeOut: number, doorIndex: number, speed: number) => {
    const target = mp.vehicles.atRemoteId(targetvehicle);
    if (!target || !mp.vehicles.exists(target)) return;
...
mp.events.add("client::task:taskPlaneChase", (targetid: Handle, x: number, y: number, z: number) => {
    const target = mp.players.atRemoteId(targetid);
    if (!target || !mp.players.exists(target)) return;
    mp.players.local.taskPlaneChase(target.handle, x, y, z);
});
mp.events.add("client::task:taskPlaneLand", (plane: Handle, runwayStartX: number, runwayStartY: number, runwayStartZ: number, runwayEndX: number, runwayEndY: number, runwayEndZ: number) => {
...
mp.events.add("client::task:taskPlaneMission", (plane: Handle, targetVehicle: Handle, targetPed: Handle, destinationX: number, destinationY: number, destinationZ: number, p7: number, physicsSpeed: number, p9: number, p10: number, maxAltitude: number, minAltitude: number) => {
    const target = mp.vehicles.atRemoteId(plane);
    if (!target || !mp.vehicles.exists(target)) return;
    mp.players.local.taskPlaneMission(target.handle, targetVehicle, targetPed, destinationX, destinationY, destinationZ, p7, physicsSpeed, p9, p10, maxAltitude, minAltitude);
});
...
mp.events.add("client::task:taskPlayAnim", (animDictionary: string, animationName: string, speed: number, speedMultiplier: number, duration: number, flag: number, playbackRate: number, lockX: boolean, lockY: boolean, lockZ: boolean) => {
...
mp.events.add("client::task:taskPlayAnimAdvanced", (animDict: string, animName: string, posX: number, posY: number, posZ: number, rotX: number, rotY: number, rotZ: number, speed: number, speedMultiplier: number, duration: number, flag: any, animTime: number, p14: any, p15: any) => {
...
mp.events.add("client::task:taskPutDirectlyIntoMelee", (meleeTarget: Handle, p2: number, p3: number, p4: number, p5: boolean) => {
...
mp.events.add("client::task:taskReactAndFlee", (fleeTarget: Handle) => {
...
mp.events.add("client::task:taskSeekCoverFrom", (fleeTarget: Handle, duration: number, p3: boolean) => {
    const target = mp.players.atRemoteId(fleeTarget);
    if (!target || !mp.players.exists(target)) return;
...
mp.events.add("client::task:taskShuffleToNextVehicleSeat", (vehicle: Handle) => {
    mp.players.local.taskShuffleToNextVehicleSeat(vehicle);
});
...
mp.events.add("client::task:taskSmartFlee", (fleeTarget: Handle, distance: number, fleeTime: any, preferPavements: boolean, updateToNearestHatedPed: boolean) => {
    const target = mp.players.atRemoteId(fleeTarget);
    if (!target || !mp.players.exists(target)) return;
...
mp.events.add("client::task:taskStealthKill", (targetid: Handle, killType: Hash, p3: number, p4: boolean) => {
    const target = mp.players.atRemoteId(targetid);
    if (!target || !mp.players.exists(target)) return;
...
mp.events.add("client::task:taskSweepAim", (anim: string, p2: string, p3: string, p4: string, p5: number, vehicle: Handle, p7: number, p8: number) => {
    mp.players.local.taskSweepAim(anim, p2, p3, p4, p5, vehicle, p7, p8);
});
mp.events.add("client::task:taskSynchronizedScene", (scene: number, animDictionary: string, animationName: string, speed: number, speedMultiplier: number, duration: number, flag: number, playbackRate: number, p9: any) => {
...
mp.events.add("client::task:taskTurnToFace", (entity: Handle, duration: number) => {
    const target = mp.players.atRemoteId(entity);
    if (!target || !mp.players.exists(target)) return;
...
mp.events.add("client::task:taskVehicleAimAt", (entity: Handle) => {
    const target = mp.players.atRemoteId(entity);
    if (!target || !mp.players.exists(target)) return;
    mp.players.local.taskVehicleAimAt(target.handle);
});
mp.events.add("client::task:taskVehicleChase", (targetEnt: Handle) => {
    const target = mp.players.atRemoteId(targetEnt);
    if (!target || !mp.players.exists(target)) return;
    mp.players.local.taskVehicleChase(target.handle);
});
mp.events.add("client::task:taskVehicleDriveToCoord", (vehicle: Handle, x: number, y: number, z: number, speed: number, p6: any, vehicleModel: Hash, drivingMode: number, stopRange: number, p10: number) => {
...
mp.events.add("client::task:taskVehicleDriveToCoordLongrange", (vehicle: Handle, x: number, y: number, z: number, speed: number, driveMode: number, stopRange: number) => {
    const target = mp.vehicles.atRemoteId(vehicle);
    if (!target || !mp.vehicles.exists(target)) return;
    mp.players.local.taskVehicleDriveToCoordLongrange(target.handle, x, y, z, speed, driveMode, stopRange);
});
mp.events.add("client::task:taskVehicleDriveWander", (vehicle: Handle, speed: number, drivingStyle: number) => {
    const target = mp.vehicles.atRemoteId(vehicle);
    if (!target || !mp.vehicles.exists(target)) return;
    mp.players.local.taskVehicleDriveWander(target.handle, speed, drivingStyle);
});
mp.events.add("client::task:taskVehicleEscort", (vehicle: Handle, targetveh: Handle, mode: number, speed: number, drivingStyle: number, minDistance: number, p7: number, noRoadsDistance: number) => {
    const target = mp.vehicles.atRemoteId(vehicle);
...
mp.events.add("client::task:taskVehicleFollow", (vehicle: Handle, targetEntity: Handle, drivingStyle: number, speed: number, minDistance: number) => {
    const target = mp.vehicles.atRemoteId(vehicle);
    if (!target || !mp.vehicles.exists(target)) return;
    mp.players.local.taskVehicleFollow(target.handle, targetEntity, drivingStyle, speed, minDistance);
});
mp.events.add("client::task:taskVehicleFollowWaypointRecording", (vehicle: Handle, WPRecording: string, p3: number, p4: number, p5: number, p6: number, p7: number, p8: boolean, p9: number) => {
    const target = mp.vehicles.atRemoteId(vehicle);
    if (!target || !mp.vehicles.exists(target)) return;
    mp.players.local.taskVehicleFollowWaypointRecording(target.handle, WPRecording, p3, p4, p5, p6, p7, p8, p9);
});
mp.events.add("client::task:taskVehicleGotoNavmesh", (vehicle: Handle, x: number, y: number, z: number, speed: number, behaviorFlag: number, stoppingRange: number) => {
    const target = mp.vehicles.atRemoteId(vehicle);
    if (!target || !mp.vehicles.exists(target)) return;
    mp.players.local.taskVehicleGotoNavmesh(target.handle, x, y, z, speed, behaviorFlag, stoppingRange);
});
mp.events.add("client::task:taskVehicleHeliProtect", (vehicle: Handle, entityToFollow: Handle, targetSpeed: number, p4: number, radius: number, altitude: number, p7: number) => {
    const target = mp.vehicles.atRemoteId(vehicle);
    if (!target || !mp.vehicles.exists(target)) return;
...
mp.events.add("client::task:taskVehicleMissionCoorsTarget", (vehicle: Handle, x: number, y: number, z: number, p5: number, p6: number, p7: number, p8: number, p9: number, p10: boolean) => {
    const target = mp.vehicles.atRemoteId(vehicle);
    if (!target || !mp.vehicles.exists(target)) return;
    mp.players.local.taskVehicleMissionCoorsTarget(target.handle, x, y, z, p5, p6, p7, p8, p9, p10);
});
mp.events.add("client::task:taskVehicleMissionTarget", (vehicle: Handle, pedTarget: Handle, mode: number, maxSpeed: number, drivingStyle: number, minDistance: number, p7: number, p8: boolean) => {
    const target = mp.vehicles.atRemoteId(vehicle);
    if (!target || !mp.vehicles.exists(target)) return;
    mp.players.local.taskVehicleMissionTarget(target.handle, pedTarget, mode, maxSpeed, drivingStyle, minDistance, p7, p8);
});
mp.events.add("client::task:taskVehiclePark", (vehicle: Handle, x: number, y: number, z: number, heading: number, mode: number, radius: number, keepEngineOn: boolean) => {
    mp.players.local.taskVehiclePark(vehicle, x, y, z, heading, mode, radius, keepEngineOn);
});
mp.events.add("client::task:taskVehicleTempAction", (vehicle: Handle, action: number, time: number) => {
    const target = mp.vehicles.atRemoteId(vehicle);
    if (!target || !mp.vehicles.exists(target)) return;
...
mp.events.add("client::task:taskWarpIntoVehicle", (vehicle: Handle, seat: number) => {
    const target = mp.vehicles.atRemoteId(vehicle);
    if (!target || !mp.vehicles.exists(target)) return;
    mp.players.local.taskWarpIntoVehicle(target.handle, seat);
});
mp.events.add("client::task:taskWrithe", (targetid: Handle, time: number, p3: number) => {
    const target = mp.players.atRemoteId(targetid);
    if (!target || !mp.players.exists(target)) return;
...
mp.events.add("client::task:updateTaskAimGunScriptedTarget", (p1: Handle, p2: number, p3: number, p4: number, p5: boolean) => {
